...
Project Structure
carenest-helper-service/ ├── src/main/java/com/carenest/helper/ │ ├── controller/ │ │ └── HelperController.java │ ├── dto/ │ │ └── RegisterRequest.java │ ├── service/ │ │ └── HelperRegistrationService.java │ ├── entity/ │ │ └── Helper.java (optional future) │ ├── repository/ │ │ └── HelperRepository.java (optional future) │ └── HelperApplication.java ├── src/main/resources/ │ └── application.properties ├── Dockerfile ├── docker-compose.yml (optional) └── README.md
